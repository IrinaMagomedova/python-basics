...
class Cell:
    ...
    def __add__(self, other):
        self.result_cell = self.units + other.units
        return self.result_cell

    def __sub__(self, other):
        self.result_cell = self.units - other.units
        if self.result_cell <= 0:
    ...
    def make_order(self, units_in_row):
        self.units_in_row = units_in_row
        self.rows = self.units // self.units_in_row
        self.rest = self.units % self.units_in_row
        return str(('*' * self.units_in_row+r'\n') * self.rows + '*' * self.rest)
